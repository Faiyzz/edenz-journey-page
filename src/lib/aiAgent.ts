...
class StudyAbroadAgent {
  ...
  async generateResponse(
    ...
    try {
      ...
      return (
        ...
        "I'm sorry, I couldn't process your request. Please try again or contact our office directly."
      );
    } catch (error) {
  ...
  private getFallbackResponse(message: string): string {
    ...
    if (
      ...
      lowerMessage.includes("toefl") ||
      lowerMessage.includes("gre") ||
      lowerMessage.includes("gmat")
    ) {
    ...
    if (
      ...
      return "I'd be happy to arrange a personalized consultation! Our expert counselors can discuss your specific goals, academic background, and create a customized plan. You can book a consultation through our website or contact us directly at +92 333 4228697.";
    }
    ...
    return "That's a great question about studying abroad! For personalized guidance based on your specific situation, I'd recommend booking a consultation with our expert counselors. We can discuss your goals, academic background, and create a customized plan for your study abroad journey. Contact us at +92 333 4228697 or visit our office in Lahore.";
  }
}
...
export async function sendChatMessage(
  ...
  const response = await studyAbroadAgent.generateResponse(
    message,
    conversationHistory
  );
